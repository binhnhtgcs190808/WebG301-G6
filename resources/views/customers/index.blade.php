                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="text_img">
                                        <figure><img src="./customers/images/pct.png" alt="#" /></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="three_box">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="box_text">
                        <i><img src="./customers/images/thr.png" alt="#" /></i>
                        <h3>Computer</h3>
                ...
                <div class="col-md-4">
                    <div class="box_text">
                        <i><img src="./customers/images/thr1.png" alt="#" /></i>
                        <h3>Laptop</h3>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                            suffered alteration in some form, by injected humour, or randomised words which don't look
                            even slightly believable. </p>
                ...
                <div class="col-md-4">
                    <div class="box_text">
                        <i><img src="./customers/images/thr2.png" alt="#" /></i>
                        <h3>Tablet</h3>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                            suffered alteration in some form, by injected humour, or randomised words which don't look
                            even slightly believable. </p>
                        ...
                        <div class="row">
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product1.png" alt="#" /></figure>
                                    <h3>Computer</h3>
                                </div>
                            </div>
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product2.png" alt="#" /></figure>
                                    <h3>Laptop</h3>
                                </div>
                            </div>
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product3.png" alt="#" /></figure>
                                    <h3>Tablet</h3>
                                </div>
                            </div>
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product4.png" alt="#" /></figure>
                                    <h3>Speakers</h3>
                                </div>
                            </div>
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product5.png" alt="#" /></figure>
                                    <h3>internet</h3>
                                </div>
                            </div>
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product6.png" alt="#" /></figure>
                                    <h3>Hardisk</h3>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product7.png" alt="#" /></figure>
                                    <h3>Rams</h3>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product8.png" alt="#" /></figure>
                                    <h3>Bettery</h3>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="product_box">
                                    <figure><img src="./customers/images/product9.png" alt="#" /></figure>
                                    <h3>Drive</h3>
                                </div>
                            </div>
                            <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="laptop_box">
                        <figure><img src="./customers/images/pc.png" alt="#" /></figure>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="carousel-caption ">
                                        <div class="row">
                                            <div class="col-md-9 offset-md-3">
                                                <div class="test_box">
                                                    <i><img src="./customers/images/cos.png" alt="#" /></i>
                                                    <h4>Sandy Miller</h4>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <img class="logo1" src="./customers/images/logo1.png" alt="#" />
