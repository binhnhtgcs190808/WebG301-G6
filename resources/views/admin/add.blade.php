...
<body>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form id="addProductForm" action="{{ url('admin/save') }}" method="POST">
                                        @csrf
                                        <div class="mb-3 mt-3">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ url('admin/catStore') }}" method="POST">
                                        @csrf
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form id="addAdminForm" action="{{ url('admin/store') }}" method="POST">
                                        @csrf
                                        <div class="mb-3 mt-3">
                                            <label for="name">Name:</label>
                                            <input type="text" class="form-control" id="name"
                                        ...
                                        <div class="mb-3 mt-3">
                                            <label for="password">Password:</label>
                                            <input type="password" class="form-control" id="password"
                                                placeholder="Confirm you password" name="password_confirmation"
                                                required>
                                        </div>
                                        <!--<div class="mb-3 mt-3">
                                            <label for="type">Role:</label>
                                            <input type="type" class="form-control" id="type" value="admin"
                                                placeholder="Type" required name="type">
                                        </div>-->
                                        <button type="update" class="btn btn-primary">Create</button>
    ...
    <!--<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Hiển thị form thêm sản phẩm khi bấm nút
            addProductButton.addEventListener('click', function() {
                addProductForm.style.display = 'block';
                addAdminForm.style.display = 'none';
            });

            // Hiển thị form thêm admin khi bấm nút
            addAdminButton.addEventListener('click', function() {
                addAdminForm.style.display = 'block';
                addProductForm.style.display = 'none';
            });
        });
    </script>--> <!--cái script này dùng để điều hướng button vào form-->
</body>
